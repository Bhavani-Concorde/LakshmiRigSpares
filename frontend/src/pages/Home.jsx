...
const features = [
    ...
    { icon: FiAward, title: '30+ Years Experience', description: 'Trusted by industry leaders since 1990' }
]
...
const categories = [
    ...
    { name: 'Pumps & Valves', image: 'https://images.unsplash.com/photo-1559757175-5700dde675bc?w=400&h=300&fit=crop', count: '100+ Products' },
                ...
                <div className="hero-content container">
                    <div className="hero-text">
                        ...
                        <p className="hero-description">
                            ...
                            Serving the oil & gas industry with excellence since 1990.
                        </p>
